...
class SpeakerViewHelper extends AbstractTagBasedViewHelper
{
    /**
     * @var string
     */
    ...
    public function initializeArguments(): void
    {
        ...
        $this->registerArgument('speaker', Speaker::class, 'The speaker to link to', true);
    ...
    public function render(): string
    {
        ...
        if (!$request instanceof ServerRequestInterface) {
            throw new \RuntimeException(
                'ViewHelper sessionplanervh:link.be.speaker needs a request implementing ServerRequestInterface.',
                1684305290
            );
        }

        /** @var Speaker $speaker */
        $speaker = $this->arguments['speaker'];
        ...
        $linkText = $this->renderChildren() ?? $speaker->getName();
