<?php
namespace Evoweb\Sessionplaner\ViewHelpers\PageRenderer;
...
class AddCssFileViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper
{
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('media', 'strong', '', false, 'all');
        ...
        $this->registerArgument('excludeFromConcatenation', 'string', '', false, false);
    }
